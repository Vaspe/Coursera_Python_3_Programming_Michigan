...
assert aa.name == 'John'
#assert aa.years_UM == 2 #error setting years
assert aa.knowledge == 0 
aa.study()
print(aa.study())
#assert aa.knowledge ==1
print(aa.knowledge) # study doesn ont add to knowledge
#assert aa.getKnowledge() == 0
print(aa. getKnowledge()) # get knowledge gives o instead of 0!
print(aa.year_at_umich() )
assert aa.year_at_umich() == 1 # get givers the correct output
